...
///////////////////////////////////////////
// 规则文件使用的宏
#define PHOENIX_SERVICE_DLL_NAME "PhoenixLSP.dll"
#define PHOENIX_PRODUCT_ID		 0xFF01
#define RULE_FILE_NAME			"prule.fnk"
...
#define RULE_HEADER_WEB_URL		"http://www.HackProLabs.com/\0"
#define RULE_HEADER_EMAIL		"admin@HackProLabs.com\0"
