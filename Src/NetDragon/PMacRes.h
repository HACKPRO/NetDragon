...
///////////////////////////////////////////
// 规则文件使用的宏
#define PHOENIX_SERVICE_DLL_NAME "dll/MyFireWallLSP.dll"
#define PHOENIX_PRODUCT_ID		 0xFF01
#define RULE_FILE_NAME			"SysRule.dat"	//  prule.fnk
#define RULE_HEADER_SIGNATURE	"PHOENIX/INC\0"
...
#define RULE_HEADER_WEB_URL		"http://www.HackProLabs/\0"
#define RULE_HEADER_EMAIL		"WinHunter@163.com\0"
